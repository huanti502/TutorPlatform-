        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    XpLevel = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeachingArea = table.Column<string>(type: "text", nullable: false),
                    HourlyRate = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    TeachingMode = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuizAttempts_Subjects_SubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeetingRoomId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Certificates_TutorProfiles_TutorProfileId",
                        column: x => x.TutorProfileId,
                        principalTable: "TutorProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TutorBadges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TutorBadges_Badges_BadgeId",
                        column: x => x.BadgeId,
                        principalTable: "Badges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TutorBadges_TutorProfiles_TutorProfileId",
                        column: x => x.TutorProfileId,
                        principalTable: "TutorProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SummarizedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReviewReplies_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Badges",
                columns: new[] { "Id", "Color", "Description", "Icon", "Name", "RequiredCount", "Type" },
                values: new object[,]
                {
                    { 1, "#4CAF50", "Hoàn thành buổi học đầu tiên", "🌱", "Khởi đầu", 1, 0 },
                    { 2, "#2196F3", "Hoàn thành 10 buổi học", "⚡", "Đang lên", 10, 0 },
                    { 3, "#9C27B0", "Hoàn thành 50 buổi học", "🎯", "Chuyên nghiệp", 50, 0 },
                    { 4, "#FFD700", "Hoàn thành 100 buổi học", "🏆", "Huyền thoại", 100, 0 },
                    { 5, "#FF9800", "Nhận được 5 lượt đánh giá", "⭐", "Được yêu thích", 5, 2 },
                    { 6, "#FF5722", "Nhận được 20 lượt đánh giá", "🌟", "Top Rated", 20, 2 },
                    { 7, "#00BCD4", "Điểm TB ≥ 4.5⭐ (ít nhất 5 đánh giá)", "💎", "Gia sư xuất sắc", 45, 1 },
                    { 8, "#E91E63", "Điểm TB ≥ 4.8⭐ (ít nhất 5 đánh giá)", "👑", "Hoàn hảo", 48, 1 },
                    { 9, "#607D8B", "Dạy từ 3 môn học trở lên", "📚", "Đa năng", 3, 3 },
                    { 10, "#795548", "Tích lũy doanh thu 1,000,000 VNĐ", "💰", "Triệu phú", 1000, 4 }
                });

            migrationBuilder.InsertData(
                table: "Subjects",
                columns: new[] { "Id", "Description", "IsActive", "Level", "Name" },
                values: new object[,]
                {
                    { 1, null, true, "THPT", "Toán học" },
                    { 2, null, true, "THPT", "Tiếng Anh" },
                    { 3, null, true, "THPT", "Vật lý" },
                    { 4, null, true, "THPT", "Hóa học" },
                    { 5, null, true, "Đại học", "Lập trình" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certificates_TutorProfileId",
                table: "Certificates",
                column: "TutorProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAttempts_SubjectId",
                table: "QuizAttempts",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TutorBadges_BadgeId",
                table: "TutorBadges",
                column: "BadgeId");

            migrationBuilder.CreateIndex(
                name: "IX_TutorBadges_TutorProfileId",
                table: "TutorBadges",
                column: "TutorProfileId");
